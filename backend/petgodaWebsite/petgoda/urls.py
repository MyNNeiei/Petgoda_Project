...
urlpatterns = [
    ...
    path('users/', views.user_list, name='user_list'),  # Get all users
    path('hotels/', views.hotel_list, name='hotel-list'),  # Get all hotels
    ...
    path('users/<int:user_id>/update_status/', views.update_user_status, name='update_user_status'),  # Update user status
